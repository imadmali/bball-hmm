...
# full data: defense_evt244.RDS
# low res: defense_evt244_low_res.RDS

pt <- readRDS("evt244_0021500411.RDS")
...
saveRDS(stan_data, "defense_evt244.RDS")
saveRDS(stan_data_low_res, "defense_evt244_low_res.RDS")
